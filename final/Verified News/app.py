...
class NewsApp:
    ...
    def __init__(self):
        ...
        # fetch data
        self.data = requests.get('https://newsapi.org/v2/top-headlines?country=us&apiKey=655cf0b44b9841c9b6fd80bdc8f3b87a').json()
        # initial GUI load
        self.load_gui()
    ...
    def load_gui(self):
        ...
        self.root.title('News Read It Right')
    ...
    def load_news_item(self,index):
        ...
        try:
            ...
            img_url = 'https://cdn.vectorstock.com/i/1000x1000/82/99/no-image-available-like-missing-picture-vector-43938299.webp'
            raw_data = urlopen(img_url).read()
            im = Image.open(io.BytesIO(raw_data)).resize((350, 250))
            photo = ImageTk.PhotoImage(im)
